...
parser.add_argument('--lr_sh_rate', type=int, default=15,
...
def train(epoch, model, optimizer, checkpoint_dir, loader_train):
    ...
    for cnt, batch in enumerate(loader_train):
        ...
        # obs_traj observed absolute coordinate [1 N 8 obs_len]
        # pred_traj_gt ground truth absolute coordinate [1 N 8 pred_len]
        # obs_traj_rel velocity of observed trajectory [1 N 8 obs_len]
        # pred_traj_gt_rel velocity of ground-truth [1 N 8 pred_len]
        ...
        # V_obs input graph of observed trajectory represented by velocity  [1 obs_len N 9]
        # V_tr target graph of ground-truth represented by velocity  [1 pred_len N 8]
...
def main(args):
    ...
    dset_val = AgentTrajectoryDataset(
        data_set + 'val/',
        obs_len=obs_seq_len,
        pred_len=pred_seq_len,
        skip=1)
    ...
    checkpoint_dir = './checkpoints/stanFordDrone/'
    ...
    for epoch in range(args.num_epochs):
        ...
        print('*' * 30)
        print('Epoch: StanFordDrone ', epoch)
